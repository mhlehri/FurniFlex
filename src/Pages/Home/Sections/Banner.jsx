const Banner = () => {
  return (
    <div className="bg-[url('/public/assets/BannerBackground.png')]  bg-fixed bg-cover w-full h-[85vh] flex justify-end">
      <div className="w-[35%]  rounded-xl  p-9  space-y-3  bg-[#FFF3E3] self-center mr-10">
        ...
        <button className="font-bold lg:py-6 lg:px-16 text-white bg-[#B88E2F]">
          Buy Now
        </button>
      </div>
    </div>
